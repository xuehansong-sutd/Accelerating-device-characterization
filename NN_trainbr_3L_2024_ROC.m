...
%
%
% Training of neural networks (Rec at OC)
%
% Author: Zhao Xinhai
...
output_data_train = load('Data_100k_v2\output3.mat'); % Output data (seen)
...
output_data_vali = load('Data_10k_rng1_v2\output3.mat'); % Output data (unseen)
input_V = input_data_vali.input;
output_V = output_data_vali.output;

% Test data
input_data_test = load('Data_10k_rng2_v2\input.mat'); % input data (seen)
output_data_test = load('Data_10k_rng2_v2\output3.mat'); % Output data (seen)
...
net.trainParam.lr = 0.0194;   % Initial learning rate
net.trainParam.min_grad = 6.08e-8;
net.trainParam.mc = 0.873;  % Momentum
% Transfer functions
...
save('NN_3L_Perfold_100k_ROC','net','valError','tr','PS_input','PS_output');