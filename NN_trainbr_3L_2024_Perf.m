...
%
%
% Training of neural networks (device Voc, FF and PCE)
%
% Author: Zhao Xinhai
...
output_data_train = load('Data_100k_v2\output1.mat'); % Output data (seen)
...
output_data_vali = load('Data_10k_rng1_v2\output1.mat'); % Output data (unseen)
...
output_data_test = load('Data_10k_rng2_v2\output1.mat'); % Output data (unseen)
...
net.trainParam.lr = 0.0118;   % Initial learning rate
net.trainParam.min_grad = 7.83e-8;
net.trainParam.mc = 0.540;  % Momentum
% Transfer functions
...
save('NN_3L_Perfold_100k','net','valError','tr','PS_input','PS_output');